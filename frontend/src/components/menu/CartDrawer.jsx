    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative bg-white w-full max-w-sm flex flex-col h-full">
              ...
              <div key={item._id} className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="w-6 h-6 rounded-full bg-gray-200 font-bold"
                  >
                    −
                  </button>
                  ...
                  <button
                    ...
                    className="w-6 h-6 rounded-full bg-primary text-white font-bold"
                  >
                    +
                  </button>
                </div>
        ...
        <div className="border-t p-4 space-y-3">
          ...
          {/* ✅ QR user → locked */}
          {orderType === 'dine-in' && isQR && tableNumber && (
            <div className="text-sm text-gray-600">
              📍 Table: <span className="font-semibold">{tableNumber}</span>
            </div>
          )}

          {/* ✅ Manual dine-in → editable */}
          {orderType === 'dine-in' && !isQR && (
            <div>
