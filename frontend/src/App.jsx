  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route element={<AdminLayout settings={settings} setSettings={setSettings} />}>
          <Route path="/admin/overview" element={<Overview settings={settings} />} />
          <Route path="/admin/categories" element={<Categories />} />
          <Route path="/admin/menu-items" element={<MenuItems />} />
          <Route path="/admin/orders" element={<Orders settings={settings} />} />
          <Route path="/admin/tables" element={<Tables />} />
          <Route path="/admin/settings" element={<Settings onSettingsUpdate={setSettings} />} />
        </Route>
